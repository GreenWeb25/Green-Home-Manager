...
const STYLES = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .card-label { font-size: 0.78rem; color: var(--text-secondary); margin-bottom: 6px; text-transform: uppercase; letter-spacing: 0.06em; }
  .card-value { font-size: 1.6rem; font-weight: 700; font-family: 'Space Mono', monospace; letter-spacing: -0.5px; }
  ...
  .cost-name { flex: 1; color: var(--text-secondary); font-size: 0.88rem; }
  .cost-amount { font-family: 'Space Mono', monospace; font-size: 0.92rem; color: var(--text-primary); }
...
const TABS = [
  { id: 'budget', label: 'Budget & Costi', icon: '📊' },
      ...
      <div className="app-shell">
        ...
        <nav className="top-nav">
          <div className="nav-brand">
            ...
            <div>
              Green Home Manager
              <span className="brand-sub">Gestione Cantiere — Budget 19.000€</span>
            </div>
          </div>
